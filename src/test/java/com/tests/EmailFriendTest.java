...
public class EmailFriendTest extends TestBase {
    ...
    String email = "mahmoudshukri354@gmail.com";
    String friendEmail = "tester@gmail.com";
    ...
    public void RegisteredUserCanSendMailForProduct() {
        detailsObj.openSendEmail();
        emailPageObj = new EmailPage(driver);
        emailPageObj.SendEmailToFriend(friendEmail, "Hello , find this product is interesting");
        Assert.assertTrue(emailPageObj.checkMessageNotification());
        Assert.assertEquals(emailPageObj.getMessageNotification(), "Your message has been sent.");
    }

    //5.User LogOut
    @Test(priority = 5, dependsOnMethods = "RegisteredUserCanSendMailForProduct")
